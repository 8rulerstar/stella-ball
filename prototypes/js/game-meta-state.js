...
const META_COPY = {
  ...
  en: {
    ...
    firstRunBody:
      "Progress, gold, unlocks, achievements and attendance saved in this browser are erased, and the intro and onboarding lessons play again from the start. This cannot be undone.",
