...
const tutorialSteps = [
  ...
  },
  {
    tag: "02 / 06 · 공명",
    title: "공명으로 각성 준비",
    text: "유성이 별지기에 닿으면 공명이 자동으로 일어나 둘이 함께 움직이고, 별지기 둘레에 각성 준비 고리가 켜집니다. 부딪힌 자리에는 작은 별빛도 남습니다.",
    art: "../assets/library/projectiles/support-bolt.png",
  },
  {
    tag: "03 / 06 · 조준",
    title: "별빛 세 곳을 선택",
    text: "유성이 멈추면 밝게 빛나는 곳을 세 군데 고르세요. 금빛 선과 번호 1·2·3이 나타나면 Space로 발사할 수 있고, 같은 곳을 다시 누르면 선택이 취소됩니다.",
    art: "../assets/library/projectiles/support-bolt.png",
  },
  {
    tag: "04 / 06 · 항로",
    title: "넓을수록 강하게",
    text: "유성은 고른 별빛들의 한가운데를 향합니다. 서로 멀리 떨어진 별빛을 고를수록 더 강해지고, 판의 빈 곳을 누르면 반대 방향으로 전환됩니다.",
    art: "../assets/library/tutorial/hint-drag-shot.png",
  },
  {
    tag: "05 / 06 · 별자리",
    title: "남긴 별빛으로 완성",
    text: "조준에 고르지 않은 작은 별빛이 세 개 이상 남으면 서로 이어져 별자리가 완성됩니다. 별지기 위에 켜진 빛은 조준에만 쓰이며 사라지지 않습니다.",
    art: "../assets/library/projectiles/marked-orb.png",
  },
  {
    tag: "06 / 06 · 정산",
    title: "멈추면 각성 공격",
    text: "유성과 별지기가 모두 멈추면 각성 준비 고리가 켜진 별지기가 현재 위치에서 고유 공격을 사용합니다. 별지기마다 공격 방식이 다르므로 누구를 깨울지 항로에 포함하세요.",
    art: "../assets/library/projectiles/marked-orb.png",
  },
];
