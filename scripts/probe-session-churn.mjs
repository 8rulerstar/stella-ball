 ...
 *
 * 2026-08-23 확인 — 이 프로브의 한 표본만 보면(리스너 36 -> 93) 누수처럼
 * 읽힌다. 화면 여덟을 도는 왕복을 40·80·120·160·200회로 늘려 묶음마다 강제
 * GC 뒤 재 보니 35 -> 69 로 «한 번» 뛴 뒤 200회까지 69~71 에서 평평했고
 * 노드도 470 근처에 고정이었다. 즉 모든 화면을 한 번씩 방문한 뒤의 정착값
 * 이지 누수가 아니다 — 위 「읽는 법」이 말하는 그대로다. 다음 사람이 같은
 * 숫자를 보고 쫓지 않도록 기울기를 남긴다.
 *
