...
세로 핀볼 보드에서 룬볼을 발사하고, 범퍼·플리퍼·3인 파티 룬을 연결해 움직이는 보스 약점을 공략하는 브라우저 액션 전략 프로토타입입니다.
...
1. 28명 로스터 중 3명의 캐릭터를 고릅니다.
2. 하단 플런저를 당겼다가 놓아 룬볼의 발사 위력을 정합니다.
3. 범퍼와 캐릭터 룬을 연결하고, 하단 좌·우 탭으로 플리퍼 충격을 넣어 보스 약점을 맞힙니다.
